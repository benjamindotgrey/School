...
public class PlayWithNumbers {
    ...
    enum IceCream { chocolate, vanilla, strawberry, cream_in_cookies, neopolitan, banna_nut };
    
    // instantiate a variable of type IceCream
	...
	public static void main(String[] args) {
		...
		String valueText;
		String name = "Hassan Benjamin Shirani"; // replace with your name
		...
		do
		{
			if (value == 0) // entered a zero
			{
				...
				valueText = JOptionPane.showInputDialog(null,
					"Pleae enter your Banner number");
	...
	static void determinePay(int answer, double earnings)
	{
		...
		{	 
			...
			System.out.println("With " + fmt2.format(CHARITY) +
				" charity deductions, your earnings are: " +
				fmt1.format(earnings) );
			...
			switch(type)
			{
				...
				case 5: typeIceCream = IceCream.banna_nut; break;
